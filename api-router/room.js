...
router.get('/detail/:slug', requiredAuth(), roomController.getRoomBySlug)
router.get('/contact/:slug', requiredAuth(), roomController.getContactBySlug)
router.get('/get-list-room-by-user', requiredAuth(), roomController.getListByUser)
router.get('/get-list-contact-by-user', requiredAuth(), roomController.getListContactByUser)
...
router.get('/find-or-create-contact-room', roomController.findOrCreatetRoomContact)
