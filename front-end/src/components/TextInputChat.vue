<template>
	<div :class="['text-input', classUnique]">
		...
		<div @click="checkActiveToolbar(); updateCurentSelection()" @keyup="checkActiveToolbar(); updateCurentSelection()" @input="emitHtml" :id="idUniqueDivEdit" contenteditable="true" class="text-input-editor">
		</div>
