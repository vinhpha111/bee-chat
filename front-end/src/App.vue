  ...
  <div id="app">
    <div class="chat-main">
      <div :class="['left-bar', { show: isShowSideBar }]">
        <img @click="isShowSideBar = !isShowSideBar" class="sidebar-toggle-btn"
          src="./assets/images/menu-button-sidebar.png" />
        <LeftSideBar  v-if="$store.getters.getSocket" />
      </div>
    ...
    <loading-screen v-if="$store.getters.getLoading || $store.getters.getLoadingView" />
  </div>
</template>
